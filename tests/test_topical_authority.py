...
def clustered_site():
    ...
    return [
        {
            "url": "https://example.com/blog/seo-grundlagen",
            "title": "SEO Grundlagen Guide",
            "h1": ["SEO Grundlagen"],
            "h2": ["Was ist SEO?", "Warum SEO?"],
            "word_count": 2000,
            "internal_links": 15,
            "schema_types": ["Article"],
        },
        {
            "url": "https://example.com/blog/seo-onpage",
            "title": "SEO On-Page Optimierung",
            "h1": ["On-Page SEO"],
        ...
        {
            "url": "https://example.com/blog/seo-offpage",
            "title": "SEO Off-Page Strategien",
            "h1": ["Off-Page SEO"],
            "h2": ["Backlinks", "Social Signals"],
            "word_count": 1000,
            "internal_links": 6,
            "schema_types": ["Article"],
        },
        {
            "url": "https://example.com/blog/seo-technisch",
            "title": "Technisches SEO",
            "h1": ["Technisches SEO"],
            "h2": ["Crawling", "Indexierung"],
            "word_count": 900,
            "internal_links": 5,
            "schema_types": ["Article"],
        },
...
def flat_site():
    ...
    return [
        {
            "url": "https://example.com/pizza-rezept",
            "title": "Pizza backen",
            "h1": ["Pizza"],
            "h2": [],
            "word_count": 500,
        ...
        {
            "url": "https://example.com/gitarre-lernen",
        ...
        {
            "url": "https://example.com/wandern-alpen",
            "title": "Wanderungen Alpen",
            "h1": ["Wandern"],
            "h2": [],
            "word_count": 500,
            "internal_links": 1,
        ...
        {
            "url": "https://example.com/auto-reparatur",
            "title": "KFZ Werkstatt",
            "h1": ["Reparatur"],
            "h2": [],
            "word_count": 500,
        ...
        {
            "url": "https://example.com/yoga-kurs",
            "title": "Yoga Anfaenger",
            "h1": ["Yoga"],
            "h2": [],
            "word_count": 500,
            "internal_links": 1,
...
class TestIssueDetection:
    ...
    def test_detects_cannibalization_within_cluster(self, analyzer):
        pages = [
            {
                "url": "https://example.com/blog/seo-tipps",
                "title": "SEO Tipps fuer Anfaenger",
                "h1": ["SEO Tipps"],
                "h2": [],
                "word_count": 800,
                "internal_links": 5,
            ...
            {
                "url": "https://example.com/blog/seo-tipps-2",
                "title": "SEO Tipps fuer Profis",
                "h1": ["SEO Tipps"],
                "h2": [],
                "word_count": 800,
                "internal_links": 5,
        ...
        gsc_keywords = [
            {
                ...
                "page": "https://example.com/blog/seo-grundlagen",
                "impressions": 100,
            },
            {
                "query": "seo blog strategie",
                "page": "",
                "impressions": 50,
            },  # Gap: no ranking
        ]
        issues = analyzer.detect_issues(
            clusters, clustered_site, gsc_keywords=gsc_keywords
        )
        types = [i["type"] for i in issues]
